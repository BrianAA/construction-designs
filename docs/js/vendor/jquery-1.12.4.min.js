...
!(function (a, b) {
  ...
  var Y = function (a, b, c, d, e, f, g) {
    ...
    aa = /^\s+/,
    ba =
      "abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|summary|Design Concepts|time|video";
  function ca(a) {
    var b = ba.split("|"),
