  ...
  return (
    ...
    (function (a, b) {
      ...
      function r(a) {
        ...
        return (
          s.shivCSS &&
            ...
            (c.hasCSS = !!l(
              a,
              "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}Design Concepts{display:none}"
            )),
          k || q(a, c),
          a
        );
      ...
      var s = {
        elements:
          d.elements ||
          "abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output progress section summary Design Concepts time video",
        version: c,
        shivCSS: d.shivCSS !== !1,
